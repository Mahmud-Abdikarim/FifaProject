...
class DimClubs(models.Model):
    ...
    leagueid = models.ForeignKey(DimLeagues, db_column='leagueid', on_delete=models.CASCADE)
...
class DimPositioncategory(models.Model):
    position_categoryid = models.IntegerField(primary_key=True)
...
class DimPositions(models.Model):
    ...
    position_categoryid = models.ForeignKey(DimPositioncategory, db_column="position_categoryid", on_delete=models.CASCADE)
...
class FactPlayerstats(models.Model):
    sofifa_id = models.ForeignKey(DimPlayers, db_column="sofifa_id", on_delete=models.CASCADE)
    ...
    clubid = models.ForeignKey(DimClubs, db_column="clubid", on_delete=models.CASCADE)
    ...
    player_tags = models.CharField(max_length=250, blank=True, null=True)
    ...
    player_traits = models.CharField(max_length=250, blank=True, null=True)
